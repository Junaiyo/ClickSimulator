...
export const ArmorsMenu = (props) => {
  ...
  const [chests, _] = useState([
    ...
    ["Peitoral de ferro", "peito2.png", 250, 3, 0, 0],
    ["Peitoral de ouro", "peito3.png", 750, 4, 0, 0],
    ["Peitoral de diamante", "peito4.png", 1500, 5, 0, 0],
    ["Peitoral de obsidiana", "peito5.png", 4125, 6, 0, 0]
  ]);
